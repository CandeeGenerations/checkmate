...
export const items = sqliteTable(
  'items',
  {
    ...
    frequency: text('frequency', {enum: ['daily', 'weekly', 'monthly', 'quarterly']})
      .notNull()
      .default('daily'),
  ...
  (table) => [index('items_frequency_idx').on(table.frequency), index('items_category_idx').on(table.categoryId)],
)
